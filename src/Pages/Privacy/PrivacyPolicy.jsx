                ...
                <div className='container text-center '>
                        ...
                        <div className='col-span-2'>
                            <div className='sticky top-[2rem]'>
                                <h1 className='text-[2rem] font-semibold text-[#CC1919]'>Privacy Policy</h1>
                        ...
                        <div className='col-span-3'>
                            <div className='flex flex-col gap-6 text-lg'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Information We Collect</h1>
                                    <p>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>How We Use Your Information</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Data Sharing</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Security</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Retention of Data</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Your Rights</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Cookies and Tracking</h1>
                                    ...
                                    <h1 className='text-[#CC1919] text-base'>Changes to this Policy</h1>
