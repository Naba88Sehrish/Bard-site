                ...
                <div className='container text-center '>
                        ...
                        <div className='col-span-2'>
                            <div className='sticky top-[2rem]'>
                                <h1 className='text-[2rem] font-semibold text-[#CC1919]'>Terms & Conditions</h1>
                        ...
                        <div className='col-span-3'>
                            <div className='flex flex-col gap-6 text-lg'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Use of Services</h1>
                                    <p>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Account Information</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Payment and Billing</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Data Security</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Prohibited Activities</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Limitation of Liability</h1>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Changes to Services</h1>
                                    <p>We reserve the right to modify, suspend, or discontinue our services at any time without prior notice.</p>
                                </div>


                                <div className='flex flex-col gap-2'>
                                    <h1 className='text-[#CC1919] text-base'>Intellectual Property</h1>
                                    ...
                                    <h1 className='text-[#CC1919] text-base'> Governing Law</h1>
                                    ...
                                    <h1 className='text-[#CC1919] text-base'>Changes to Terms</h1>
                                    ...
                                    <h1 className='text-[#CC1919] text-base'>Contact Us</h1>
                                    <p>If you have questions about this Privacy Policy, you can contact us at
                                    <span className='text-[#CC1919]'> admin@bardvpn.com </span>  
                                    </p>
